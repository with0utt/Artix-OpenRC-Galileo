...
> hardware volume buttons, power button suspend, fan control, Decky Loader), see
> [`docs/experimental.md`](docs/experimental.md). Those proposed fixes have not been tested
> and are kept separate to avoid polluting this guide with unverified steps.
